    ...
    public void render(Zone zone, BufferedRenderer br){
        for (int z = 0; z < Zone.HEIGHT-1; z++){
            for (int x = 0; x < Zone.WIDTH-1; x++){
                br.addVertex3f(x, zone.getPointAt(x, z), z);
                br.addVertex3f(x, zone.getPointAt(x, z + 1), z + 1);
                br.addVertex3f(x + 1, zone.getPointAt(x + 1, z), z);

                br.addVertex3f(x, zone.getPointAt(x, z + 1), z + 1);
                br.addVertex3f(x + 1, zone.getPointAt(x + 1, z + 1), z + 1);
                br.addVertex3f(x + 1, zone.getPointAt(x + 1, z), z);
                ...
                e1 = new Vector3f(0,zone.getPointAt(x, z)-zone.getPointAt(x, z + 1), -1); //TODO: toto bude urcite zle!
                ...
                e1 = new Vector3f(-1,zone.getPointAt(x, z + 1)-zone.getPointAt(x + 1, z + 1),0); //TODO: aj toto bude urcite zle!
